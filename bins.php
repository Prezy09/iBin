...
render_header('Bins', ['active'=>'bins', 'brand'=>APP_BRAND_FULL]);
...
$now = time();
$registerableBins = array_values(array_filter($bins, static function ($bin) use ($now, $offlineWindowSeconds) {
